...
<body style="background-color:#C1E1A6">
	<div class="container">
		<div class="row">
			<form method="POST" action="doc_reg1.php">
				<div class="row">
					<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
						...
						<div class="form-group">
			 				...
			 				<input type="text" class="form-control" name="d_contact">
						</div>
					</div>
					<div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-2 col-xs-offset-2 col-lg-5 col-md-5 col-sm-5 col-xs-5">
						...
						<div class="form-group" >
			  				<label for="d_dept">Department:</label>
			 				<select class="form-control" name="d_dept">
